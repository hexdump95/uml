    ...
    graph.getElements()
        .forEach((el) => {
            elements.classes.push({
                ...
                attributes: el.attributes.attributes,
            });
        });
    graph.getLinks()
        .forEach((el) => {
            elements.connectors.push({
                id: el.id,
                type: el.attributes.type,
                source: el.attributes.source,
...
//
// paperContainer.addEventListener('touchstart', (event) => {
//     isTouching = true;
//     startX = event.touches[0].clientX;
//     startY = event.touches[0].clientY;
// });
//
// paperContainer.addEventListener('touchmove', (event) => {
//     if (isTouching) {
//         const deltaX = event.touches[0].clientX - startX;
//         const deltaY = event.touches[0].clientY - startY;
//
//         paperContainer.scrollLeft -= deltaX;
//         paperContainer.scrollTop -= deltaY;
//
//         startX = event.touches[0].clientX;
//         startY = event.touches[0].clientY;
//     }
// });
//
// paperContainer.addEventListener('touchend', () => {
//     isTouching = false;
// });
